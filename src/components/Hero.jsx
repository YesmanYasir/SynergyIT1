...
import { curve, heroBackground, globe } from "../assets";
...
const Hero = () => {
  ...
  return (
    <Section
      ...
      crosses
      crossesOffset="lg:translat  e-y-[5.25rem]"
      customPaddings
      id="hero"
    >
      <div className="container relative " ref={parallaxRef}>
        ...
        mx-auto text-center mt-28 mb-[3.8rem] md:mb-20 lg:mb:[6.25rem]"
        >
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            Your Trusted IT Partner on The Field With 200+ engineers in 20+
            countries, SyNErgy Global IT Services is your trusted solution
            partner worldwide, regardless of the size or duration of your
            projects.
          </p>
